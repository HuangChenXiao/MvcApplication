    ...
    $('.table-sort').DataTable({
        ...
        "columns": [
            ...
            },
            {
                "data": null,
                "mRender": function (data, type, full) {
                    return '<a title="编辑" href="javascript:;" onclick="layer_open(\'编辑\',\'CarouselEdit?CarouselId=' + data.CarouselId + '\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>'
