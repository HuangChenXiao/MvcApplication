        ...
        "columns": [
            {
                ...
                "mRender": function (data, type, full) {
                    return '<input type="checkbox" value="' + data.CarouselId + '" name="">'
                },
                "sTitle": "<input type='checkbox' onclick='chkcheckbox(this)' name=''></input>",
                "width": "25px"
            },
            { "data": "Title", "sTitle": "名称" },
            {
                "data": null,
                "mRender": function (data, type, full) {
            ...
            },
            {
                "data": null,
                "mRender": function (data, type, full) {
                    return '<a title="编辑" href="javascript:;" onclick="layer_open(\'编辑\',\'CustomerEdit?CarouselId=' + data.CarouselId + '\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>'
                         + '<a title="删除" href="javascript:;" data-id="' + data.CarouselId + '" onclick="single_delete(this)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>'
                },
                "sTitle": "操作"
            }
        ]
...
function dataAllDel() {
    ...
    if (chkId) {
        layer.confirm('删除须谨慎，确认要批量删除吗？', function () {
            ...
            $.post('/Carousel/DelCarousel', { "strId": $.splitSymbol(chkId) }, function (data) {
...
function single_delete(_this) {
    ...
    layer.confirm('删除须谨慎，确认要删除吗？', function (index) {
        //此处请求后台程序，下方是成功后的前台处理……
        $.post('/Carousel/DelCarousel', { "strId": Id }, function (data) {
            if (data.data == 'success') {
