...
function initDataTable() {
    $('.table-sort').DataTable({
        ...
        "columns": [
            ...
            { "data": "Company", "sTitle": "公司名称" },
            { "data": "ProjectName", "sTitle": "案例名称" },
            { "data": "ProjectTime", "sTitle": "案例时间" },
            { "data": "ProjectPrice", "sTitle": "案例报价" },
            ...
            },
            {
                "data": null,
                "mRender": function (data, type, full) {
                    return '<a title="编辑" href="javascript:;" onclick="layer_open(\'编辑\',\'CaseDetailsEdit?ProjectId=' + data.ProjectId + '\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>'
                         + '<a title="详细案例" href="/ExpandProjectDetail/CaseDetails2Index?ProjectId=' + data.ProjectId + '" target="_blank"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe667;</i></a>'
