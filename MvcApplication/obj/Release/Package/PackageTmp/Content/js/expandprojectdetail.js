...
function initDataTable() {
    $('.table-sort').DataTable({
        ...
        "ajax":
            {
                "url": "/ExpandProjectDetail/GetExpandProjectDetailList",
                "type": "post",
                "dataType": "Json",
                "data": {
        ...
        "columns": [
            ...
            },
            {
                "data": null,
                "mRender": function (data, type, full) {
                    return '<a title="编辑" href="javascript:;" onclick="layer_open(\'编辑\',\'ExpandProjectDetailEdit?Id=' + data.Id + '\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>'
...
function dataAllDel() {
    ...
    if (chkId) {
        layer.confirm('删除须谨慎，确认要批量删除吗？', function () {
            ...
            $.post('/ExpandProjectDetail/DelExpandProjectDetail', { "strId": $.splitSymbol(chkId) }, function (data) {
...
function single_delete(_this) {
    ...
    layer.confirm('删除须谨慎，确认要删除吗？', function (index) {
        //此处请求后台程序，下方是成功后的前台处理……
        $.post('/ExpandProjectDetail/DelExpandProjectDetail', { "strId": Id }, function (data) {
            if (data.data == 'success') {
