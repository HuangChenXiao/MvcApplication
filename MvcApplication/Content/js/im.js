    ...
    $('.table-sort').DataTable({
        ...
        "columns": [
            ...
            },
            {
                "data": null,
                "mRender": function (data, type, full) {
                    return '<a title="查看详情" href="javascript:;" onclick="layer_open(\'详情\',\'IMEdit?Id=' + data.Id + '\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe667;</i></a>'
...
function dataAllDel() {
    ...
    if (chkId) {
        layer.confirm('删除须谨慎，确认要批量删除吗？', function () {
            ...
            $.post('/IM/GetIMDel', { "strId": $.splitSymbol(chkId) }, function (data) {
...
function single_delete(_this) {
    ...
    layer.confirm('删除须谨慎，确认要删除吗？', function (index) {
        //此处请求后台程序，下方是成功后的前台处理……
        $.post('/IM/GetIMDel', { "strId": Id }, function (data) {
            if (data.data == 'success') {
